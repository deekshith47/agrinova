...
export const AgroBotIcon = BotIcon; // Alias
...
export const WeatherIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M17.5 19.25a3.26 3.26 0 0 0-2.21 5.5M6.5 12.75a3.26 3.26 0 0 0-2.21 5.5" />
        <path d="M12 2v10.25" />
        <path d="m16 6-8 8" />
        <path d="M8.75 3.5h6.5" />
        <path d="M12 12.25a3.25 3.25 0 0 0 3.25-3.25V3.5" />
        <path d="M12 12.25a3.25 3.25 0 0 1-3.25-3.25V3.5" />
    </svg>
);
...
export const YieldIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M5 22v-6" />
        <path d="M5 16c0-1.5 1.5-3 3-3s3 1.5 3 3v6" />
        <path d="M11 16v6" />
        <path d="M11 16c0-1.5 1.5-3 3-3s3 1.5 3 3v6" />
        <path d="M17 16v6" />
        <path d="M17 13.5c0-1.5 1.5-3 3-3" />
        <path d="M20 10.5c0-1.5-1.5-3-3-3" />
        <path d="M17 7.5c0-1.5-1.5-3-3-3s-3 1.5-3 3" />
        <path d="M11 7.5c0-1.5-1.5-3-3-3s-3 1.5-3 3" />
        <path d="M8 4.5c0-1.5-1.5-3-3-3" />
    </svg>
);
...
export const PestIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 20h-4a4 4 0 0 1-4-4V8a4 4 0 0 1 4-4h12a4 4 0 0 1 4 4v2.5" />
        <path d="m14 14-2-2" />
        <path d="m12 12 2 2" />
        <path d="m10 16-2-2" />
        <path d="m8 14 2 2" />
        ...
        <path d="M20.83 15.17a3 3 0 0 0-2.83-2.83" />
        <path d="M15.17 20.83a3 3 0 0 0 2.83 2.83" />
    </svg>
);
...
export const LeafIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M11 20A7 7 0 0 1 7 4a7 7 0 0 1 4-2 7 7 0 0 1 4 2 7 7 0 0 1-4 16z" />
        <path d="M9 6a3 3 0 0 1 2-2" />
    </svg>
);
...
export const BrainCircuitIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M12 14a2.5 2.5 0 0 1 3 4" />
        <path d="M12 14a2.5 2.5 0 0 0-3 4" />
        <path d="M17.5 7.5a2.5 2.5 0 0 1 3 4" />
        <path d="M17.5 7.5a2.5 2.5 0 0 0-3 4" />
        <path d="M6.5 7.5a2.5 2.5 0 0 1 3 4" />
        <path d="M6.5 7.5a2.5 2.5 0 0 0-3 4" />
        <path d="M15 11.5h-6" />
        <path d="M9 18V6" />
        <path d="M15 18V6" />
    </svg>
...
export const StorefrontIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M3 21V9l9-7 9 7v12h-4v-7a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v7H3Z" />
    </svg>
);
...
export const LoadingSpinner: React.FC<IconProps> = ({ className = 'h-5 w-5' }) => (
